...
@Component({
  ...
  template: `
    ...
    <div class="error" *ngIf="controlDir && !controlDir.control?.valid">
...
export class RequiredTextCvaComponent implements OnInit, ControlValueAccessor {
